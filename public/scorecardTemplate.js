...
templates['leaderboard'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<body>\n<header>\n  \n"
    ...
    + "\n</header>\n<section id=\"cards\">\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.scoreData : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":8,"column":4},"end":{"line":10,"column":13}}})) != null ? stack1 : "")
    + "</section>\n\n</body>\n";
